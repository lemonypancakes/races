...
public record ActionType<T>(Class<T> typeClass, NamespacedKey key, ActionFactory<T> factory) {
    ...
    public static <T> ActionType<T> registerSimple(Class<T> typeClass, String name, BiConsumer<JsonObject, T> action) {
    ...
    public static <T> ActionType<T> register(Class<T> typeClass, NamespacedKey key, ActionFactory<T> factory) {
